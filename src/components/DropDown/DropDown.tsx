...
export default function DropDown(props: Dropdown) {
  ...
  return (
    <ul className="bg-[#EAEAEA] text-[#6D6D6D] rounded-[10px] flex-row items-center justify-center p-1 absolute right-0 top-10 shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)] z-20" ref={dropDownRef}>
